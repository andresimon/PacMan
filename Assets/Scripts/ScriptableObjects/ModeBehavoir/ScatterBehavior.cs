...
[CreateAssetMenu(fileName = "ScatterBehavior", menuName = "Mode Behaviors/Scatter", order = 51)]
public class ScatterBehavior : ModeBehavior
{
    ...
    public override Node ChooseNextNode(GameObject ghost)
    {
        ...
        targetTile = ghost.GetComponent<Ghost>().homeNode.transform.position;
